...
// HeroSection.tsx: Componente para la sección hero de Científica Flix
// Muestra una imagen de fondo con gradiente, título, descripción y botones de acción
...
export default HeroSection;  // Exporta el componente como predeterminado
