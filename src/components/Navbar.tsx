...
// Navbar.tsx: Componente para la barra de navegación de Científica Flix
// Muestra logo, enlaces de navegación, y controles de usuario con efecto de fondo al scrollear
// Inspirado en el diseño de Netflix, parte del stack Vite, React, Shadcn, TypeScript
...
export default Navbar;  // Exporta el componente como predeterminado
